...
class thermography_setup:
    """
    Class which control auxylary thermography setup with methods to change order of the filters
    """
    ...
    def taking_photo(self,motor_top,motor_bottom,top_filter,bottom_filter,encoder_top,encoder_bottom):
        """
        Main method for changing filters this is the most important part
        """
        top_index=0
        bottom_index=0
